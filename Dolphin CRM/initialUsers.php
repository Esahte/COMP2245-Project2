...
$sql = $conn->exec("INSERT INTO users (firstname, lastname, password, email, role, created_at) VALUES('Esah', 'Asong', '$hashed_password', 'admin@project2.com', 'Admin', '$created_at')");

// List of fictional first and last names for users
$userFirstNames = ["Alice", "Bob", "Charlie", "David", "Eva"];
$userLastNames = ["Smith", "Johnson", "Williams", "Jones", "Brown"];
